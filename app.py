...
CHANGELOG = [
    {'v': '12.43', 'b': '323', 'date': '14/06/2026', 'title': 'Πρόσβαση ανά ρόλο · Feedback · δυναμικά φίλτρα τμημάτων',
    ...
    {'v': '12.42', 'b': '322', 'date': '14/06/2026', 'title': 'Πρόγραμμα Εργασίας — εκκαθάριση διπλών + πρόσβαση ρόλων',
    ...
    {'v': '12.41', 'b': '321', 'date': '14/06/2026', 'title': 'Πρόγραμμα Εργασίας — multi-week, εργάσιμες, διαχείριση προσωπικού',
